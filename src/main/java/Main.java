...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Book libri1 = new Book("asdasfsdf","Viaggio oltre i confini", 2024, 2345, "Lucia", "fantasy");
        Book libri2 = new Book("12341ewr","Notte stellata", 1998, 5823, "Giovanni", "romanzo");
        Book libri3 = new Book("f1234fqerw","Le onde del destino", 2010, 3674, "Francesca", "avventura");
